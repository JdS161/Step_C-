...
namespace CW_20211226
{
    class ComplexNum
    {
        ...
        public static ComplexNum operator&(ComplexNum _firstComplexNum, ComplexNum _secondComplexNum)
        {
            if (_firstComplexNum.Re != 0 && _firstComplexNum.Im != 0 && _secondComplexNum.Re != 0 && _secondComplexNum.Im != 0)
                return _firstComplexNum;
            return new ComplexNum();
        }
        public static ComplexNum operator|(ComplexNum _firstComplexNum, ComplexNum _secondComplexNum)
        {
            if (_firstComplexNum.Re != 0 || _firstComplexNum.Im != 0)
                return _firstComplexNum;
            if (_secondComplexNum.Re != 0 || _secondComplexNum.Im != 0)
                return _secondComplexNum;
        ...
        //
        public static implicit operator ComplexNum(double _number)
        {
            return new ComplexNum(_number, 0);
        }

        public static explicit operator double(ComplexNum _complexNum)
        {
            return _complexNum.Re;
        }
